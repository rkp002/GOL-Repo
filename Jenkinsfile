...
// for display purpose
   ...
   //  git 'https://github.com/rkp002/GOL-Repo.git'
...
//}
  ...
  stage('Sonarqube') {
    ...
    stage('Deploy War') {
      steps {
          //deploy adapters: [tomcat8(credentialsId: 'tomcat-cred', path: '', url: 'http://3.16.112.74:8080/')], contextPath: null, war: '**/*.war'
...
post {
        ...
        failure {
            mail to:"karthik.pr555@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
